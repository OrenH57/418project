  ...
  return (
    <div className="min-h-screen bg-[var(--page-bg)]">
      ...
      <div className="mx-auto max-w-6xl px-4 py-4 sm:py-6">
        <section className="rounded-[1.5rem] border border-[var(--border)] bg-white p-4 shadow-sm sm:rounded-[2rem] sm:p-5">
          <div className="grid gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm text-[var(--muted)] sm:mt-3 sm:text-lg">
              ...
              <p className="mt-1.5 text-sm text-[var(--muted)] sm:hidden">
                Order in GET. A student brings it to you.
              </p>
              <div className="mt-3 grid gap-2 sm:mt-5 sm:flex sm:flex-wrap sm:gap-3">
              ...
              <div className="mt-3 flex flex-wrap gap-2 text-sm text-[var(--muted)] sm:mt-5 sm:gap-3">
            ...
            <div className="space-y-3">
              ...
              <Card className="overflow-hidden border-none bg-[var(--brand-maroon)] text-white shadow-xl">
                <CardContent className="p-4 sm:p-5">
                  <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-2xl bg-white/12 sm:h-11 sm:w-11">
            ...
            return (
              <Card key={card.title} className="border-[var(--border)] bg-white">
                <CardContent className="p-4">
                  ...
                  <p className="mt-1.5 hidden text-sm text-[var(--muted)] sm:block">{card.body}</p>
                </CardContent>
              </Card>
            );
          })}
