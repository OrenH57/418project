...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", type = "button", ...props }, ref) => {
    return (
      <button
        className={cn(
          "inline-flex cursor-pointer items-center justify-center rounded-lg text-center font-medium transition-all duration-150",
          ...
          variant === "default" &&
            "border border-[var(--brand-maroon)] bg-[var(--brand-maroon)] px-4 py-2 text-white shadow-sm hover:bg-[var(--brand-maroon-deep)] active:shadow-none",
          variant === "secondary" &&
            "border border-[#dfc783] bg-[var(--gold-soft)] px-4 py-2 text-[var(--ink)] shadow-sm hover:bg-[#f1dfad]",
